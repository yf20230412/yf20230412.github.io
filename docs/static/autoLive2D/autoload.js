try {
    $("<link>").attr({href: "https://yf1688.top/static/autoLive2D/waifu.min.css", rel: "stylesheet", type: "text/css"}).appendTo('head');
    $('body').append('<div class="waifu"><div class="waifu-tips"></div><canvas id="live2d" class="live2d"></canvas><div class="waifu-tool"><span class="fui-home"></span> <span class="fui-chat"></span> <span class="fui-eye"></span> <span class="fui-user"></span> <span class="fui-photo"></span> <span class="fui-info-circle"></span> <span class="fui-cross"></span></div></div>');
    $.ajax({url: 'https://yf1688.top/static/autoLive2D/waifu-tips.min.js', dataType:"script", cache: true, success: function() {
        $.ajax({url: 'https://yf1688.top/static/autoLive2D/live2d.min.js', dataType:"script", cache: true, success: function() {
            /* 可直接修改部分参数 */
